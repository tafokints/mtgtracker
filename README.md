...
- Admin promotion efficiency compares promotion actions with affiliate clicks by tracker so promoted discoveries can be judged against monetizable traffic.
...
- Promotion efficiency: use the admin panel `Affiliate` tab to compare promotion actions with downstream affiliate clicks by tracker.
